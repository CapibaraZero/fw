...
void NFCBruteforceTagPage::display() {
  ...
  bruteforce_info = new Text(screen, ST77XX_WHITE, english_words->at(NFC_BRUTEFORCING_TAG_KEY));
  tried_keys = new Text(screen, ST77XX_WHITE, english_words->at(NFC_TRIED_KEYS_KEY));
  found_keys = new Text(screen, ST77XX_BLACK, english_words->at(NFC_FOUND_KEYS_KEY));
