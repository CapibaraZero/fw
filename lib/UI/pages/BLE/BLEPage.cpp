...
void BLEPage::display() {
    ...
    apple_juice =
        new List(screen, "AppleJuice", 2, ST77XX_WHITE, 20, ST77XX_BLACK, goto_applejuice);
    samsung_ble =
        new List(screen, "Samsung BLE spam", 2, ST77XX_WHITE, 20, ST77XX_BLACK, goto_samsung_spam);
    swift_pair =
        new List(screen, "Swift pair spam", 2, ST77XX_WHITE, 20, ST77XX_BLACK, goto_swift_spam);
