...
{
    create_screen_main();
    loadScreen(ScreensEnum::SCREEN_ID_MAIN);
}

extern "C" void action_go_to_wifi_page(lv_event_t *e)
{
    create_screen_wi_fi_page();
    loadScreen(ScreensEnum::SCREEN_ID_WI_FI_PAGE);
}
...
extern "C" void action_go_to_wifi_scan(lv_event_t *e)
{
    ...
    loadScreen(ScreensEnum::SCREEN_ID_WI_FI_SCAN_PAGE);
    scan_wifi(&attack);
}
...
extern "C" void action_go_to_net_selection(lv_event_t *e)
{
    ...
    loadScreen(ScreensEnum::SCREEN_ID_WI_FI_NET_SELECTION);
}
...
extern "C" void action_wifi_start_bssid_sniffer(lv_event_t *e)
{
    ...
    loadScreen(ScreensEnum::SCREEN_ID_WI_FI_SNIFFER);
...
void show_invalid_config()
{
    ...
    loadScreen(ScreensEnum::SCREEN_ID_INVALID_CONFIG);
}
...
extern "C" void action_go_to_evilportal(lv_event_t *e)
{
    ...
    loadScreen(ScreensEnum::SCREEN_ID_EVIL_PORTAL);
}
...
extern "C" void action_go_to_dhcpglutton(lv_event_t *e)
{
    ...
    else
    {
        ...
        loadScreen(ScreensEnum::SCREEN_ID_DHCP_GLUTTON);
        // delay(2000);
    }
}
