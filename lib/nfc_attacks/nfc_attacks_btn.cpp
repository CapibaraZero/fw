...
void mifare_polling(Gui *gui, NFCAttacks *attacks) {
    ...
    params->gui = gui;
    xTaskCreate(mifare_polling_task, "mifare_polling", 4096, (void *)params, 5, &polling_task_handle);
}
...
void felica_polling(Gui *gui, NFCAttacks *attacks) {
    ...
    params->attacks = attacks;
    params->gui = gui;
    xTaskCreate(felica_polling_task, "felica_polling", 4096, (void *)params, 5, &polling_task_handle);
}
void dump_iso14443a(Gui *gui, NFCAttacks *attacks) {
    ...
    params->attacks = attacks;
    params->gui = gui;
    xTaskCreate(dump_iso14443a_task, "dump_iso14443a", 4096, (void *)params, 5, &dump_task_handle);
}
...
void dump_felica(Gui *gui, NFCAttacks *attacks) {
    ...
    params->attacks = attacks;
    params->gui = gui;
    xTaskCreate(dump_felica_task, "dump_felica", 4096, (void *)params, 5, &dump_task_handle);
}
...
void format_iso14443a(Gui *gui, NFCAttacks *attacks) {
    ...
    params->attacks = attacks;
    params->gui = gui;
    xTaskCreate(format_iso14443a_task, "mifare_polling", 4096, (void *)params, 5, &format_task_handle);
}
...
void format_felica(Gui *gui, NFCAttacks *attacks) {
    ...
    params->attacks = attacks;
    params->gui = gui;
    xTaskCreate(format_felica_task, "felica_format", 4096, (void *)params, 5, &format_task_handle);
}
...
void bruteforce_tag(Gui *gui, NFCAttacks *attacks) {
    ...
    params->attacks = attacks;
    params->gui = gui;
    xTaskCreate(bruteforce_iso14443a_task, "bruteforce_iso14443a", 4096, (void *)params, 5, &bruteforce_task_handle);
    xTaskCreate(bruteforce_update_ui_task, "bruteforce_update_ui", 4096, (void *)params, 5, &bruteforce_ui_task_handle);
}
